...
def fix_typing_imports_line(line):
    ...
    fixes = [
        # 重复的类型
        (r'\bAny,\s*[^,]*Any\b', lambda m: m.group(0).replace(re.search(r',\s*[^,]*Any\b', m.group(0)).group(), '')),
        ...
        (r'Any,\s*Dict\[str,\s*Any\],\s*Any,\s*List\[Any\],\s*Optional', 'Any, Dict, Any, List, Optional'),
