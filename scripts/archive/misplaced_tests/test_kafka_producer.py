...
def test_kafka_producer_structure():
    ...
    try:
        ...
        mock_stream_config.get_producer_config = Mock(
            return_value={
        ...
        modules_to_mock["src.streaming.stream_config"].StreamConfig = Mock(
            return_value=mock_stream_config
        )
        ...
        with patch.dict("sys.modules", modules_to_mock):
            ...
            methods = [
                ...
                "get_producer_config",
                "_serialize_message",
                "_validate_match_data",
                "_validate_odds_data",
                "_validate_scores_data",
            ]
