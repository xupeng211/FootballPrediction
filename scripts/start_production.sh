...
setup_environment() {
    ...
    # 导出必要的环境变量
    export POSTGRES_ROOT_PASSWORD=${POSTGRES_ROOT_PASSWORD:-postgres_root_pass}
    export DB_PASSWORD=${DB_PASSWORD:-football_pass}
...
show_access_info() {
    ...
    echo "  📈 Grafana监控:      http://localhost:3000 (admin/football_grafana_2025)"
