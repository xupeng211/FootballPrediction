    ...
    def generate_weekly_summary(self, audits: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for audit in audits:
            if audit['audit_type'] == 'quick' and audit['success']:
                ...
                summary['key_metrics']['total_files_with_errors'] = len(audit.get('errors_by_file', {}))
...
def main():
    ...
    parser.add_argument("--type", choices=["weekly", "quick", "detailed", "mypy"],
                       default="weekly", help="审计类型")
