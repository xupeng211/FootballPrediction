...
# A-L blocking rules — delegated to dedicated helper
# to keep this file under the 800-line gatekeeper limit.
# Re-exported for backward compatibility — external consumers import from here.
from scripts.ops.helpers.pr_authorization_rules import narrow_blocking_errors  # noqa: E402, F401
