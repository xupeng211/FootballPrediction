    ...
    def __init__(self):
        ...
        self.target_categories = {
            ...
            "International": {
                ...
                "Copa America": {"name": "Copa América", "url": "https://fbref.com/en/comps/3/copa-america", "tier": "1", "category": "International"},
            },
            ...
            "Top Tier 2": {
                ...
                "Brasileirão": {"name": "Brasileirão", "url": "https://fbref.com/en/comps/26/Serie-A-Stats", "tier": "1", "category": "Club"},
            }
        }
                ...
                for comp in competitions:
                    try:
                        ...
                        if result:
                            ...
                            saved_count += 1
                            logger.info(f"  ➕ 新增: {comp['name']} ({comp['category']})")
