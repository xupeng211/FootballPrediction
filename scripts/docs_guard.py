...
DOCS_DIR = Path("docs")
ALLOWED_TOP_DIRS = {
    "architecture", "how-to", "reference", "testing", "data",
    "ml", "ops", "release", "staging", "legacy", "_reports", "_meta"
}
...
def check_orphaned_documents():
    ...
    for file in all_files:
        ...
        if (file.name in ["INDEX.md", "README.md"] or
            "legacy" in str(file) or
            "_meta" in str(file) or
            "_reports" in str(file)):
            continue
