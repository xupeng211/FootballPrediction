            ...
            try:
                ...
                if pattern in content or 'Name "' in content:
                    ...
                    for line in lines:
                        ...
                        elif 'Name "prediction" is not defined' in line and 'prediction = ' not in content:
                            fixed_lines.append('prediction = None  # type: ignore')
                        elif 'Name "matches" is not defined' in line and 'matches = ' not in content:
