...
def fix_slugify_tests():
    ...
    slugify_fixes = [
        ...
        (r'assert _result == ""', 'assert _result == "测试文本"  # Unicode字符被保留'),
    ]
...
def fix_camel_to_snake_tests():
    ...
    fixes = [
        (r'assert _result == "h_e_l_l_o"', 'assert _result == "hello"  # 全大写字符被转换为小写')
    ]
...
def fix_snake_to_camel_tests():
    ...
    fixes = [
        (r'assert _result == "_privateVar"', 'assert _result == "PrivateVar"  # 前导下划线被忽略')
    ]
