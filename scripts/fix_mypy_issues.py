...
class MyPyIssueFixer:
        ...
        try:
            ...
            if 0 <= line_num < len(lines):
                ...
                # 处理相对导入问题
                    ...
                    issue["code"] == "misc"
                    and "Relative import climbs too many namespaces" in issue["message"]
                ):
                    # 将相对导入改为绝对导入
    ...
    def fix_all_issues(self) -> Dict:
        ...
        annotation_issues = [
            i for i in issues if i["code"] in ["var-annotated", "assignment", "name-defined"]
        ]
        ...
        ignore_issues = [
            ...
            for i in issues
            if i["code"]
            in ["no-any-return", "return-value", "union-attr", "operator", "index", "call-arg"]
        ]
