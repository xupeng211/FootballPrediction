...
class EnhancedPreCommitChecker:
    ...
    def run_check(self, name: str, command: List[str], description: str,
                  critical: bool = True, timeout: int = 60) -> Dict:
        """运行单个检查"""
        print(f"🔍 {description}...")
    ...
    def save_report(self) -> None:
        ...
        report_file = reports_dir / f"pre_commit_check_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
