...
async def test_parser():
    ...
    try:
        ...
        critical_fields = [
            ...
            ('home_big_chances_created', l2_stats.home_big_chances_created, '主队绝佳机会'),
            ('away_big_chances_created', l2_stats.away_big_chances_created, '客队绝佳机会'),
        ...
        print(f"   核心字段填充率: {filled_critical}/{len(critical_fields)} ({filled_critical/len(critical_fields)*100:.1f}%)")
