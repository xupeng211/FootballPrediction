            ...
            for model_info in models_to_evaluate:
                ...
                try:
                    ...
                    if performance["needs_retrain"]:
                        results["models_needing_retrain"] = (
                            int(results["models_needing_retrain"]) + 1
                        ...
                        results["retraining_triggered"] = (
                            int(results["retraining_triggered"]) + 1
                        )  # type: ignore[call-overload]

                        if retrain_result["success"]:
                            results["retraining_successful"] = (
                                int(results["retraining_successful"]) + 1
                            )  # type: ignore[call-overload]
                            ...
                            try:
                                ...
                                results["reports_generated"] = (
                                    int(results["reports_generated"]) + 1
                                )  # type: ignore[call-overload]
                            except Exception as e:
