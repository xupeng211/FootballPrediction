        ...
        for i, (fotmob_id, stats, lineups) in enumerate(matches, 1):
            ...
            if stats:
                try:
                    ...
                    if final_scores:
                        ...
                        print(
                            f"✅ 最终比分 (从events): {final_home_score}:{final_away_score}"
                        )
            ...
            if stats:
                try:
                    ...
                    print(
                        f"🟨 黄牌: 主队{yellow_cards['home']} - 客队{yellow_cards['away']}"
                    )
            ...
            if lineups:
                try:
                    ...
                    if home_player_ratings:
                        ...
                        print(
                            f"👥 主队首发平均评分: {avg_home_rating:.2f} (基于{len(home_player_ratings)}名球员)"
                        )
                    ...
                    if away_player_ratings:
                        ...
                        print(
                            f"👥 客队首发平均评分: {avg_away_rating:.2f} (基于{len(away_player_ratings)}名球员)"
                        )
