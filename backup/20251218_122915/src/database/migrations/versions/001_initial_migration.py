...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "home_team", sa.String(length=100), nullable=False, comment="主队名称"
        ),
        sa.Column(
            "away_team", sa.String(length=100), nullable=False, comment="客队名称"
        ),
        ...
        sa.Column(
            "bookmaker", sa.String(length=100), nullable=False, comment="博彩公司"
        ),
        ...
        sa.Column(
            "implied_home_prob", sa.Float(), nullable=True, comment="主胜隐含概率"
        ),
        sa.Column(
            "implied_draw_prob", sa.Float(), nullable=True, comment="平局隐含概率"
        ),
        sa.Column(
            "implied_away_prob", sa.Float(), nullable=True, comment="客胜隐含概率"
        ),
        sa.Column(
            "data_source", sa.String(length=50), nullable=True, comment="数据来源"
        ),
