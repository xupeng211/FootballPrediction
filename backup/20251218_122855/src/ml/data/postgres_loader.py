...
class PostgresDataLoader:
    ...
    def __init__(
        ...
        self.selected_columns = selected_columns or [
            ...
            'home_xi_rating', 'away_xi_rating',
            'home_star_rating', 'away_star_rating',
            'home_bench_rating', 'away_bench_rating',
    ...
    def _get_empty_dataframe(self) -> pd.DataFrame:
        ...
        columns = self.selected_columns or [
            ...
            # Phase 8: Metadata
            'referee', 'stadium', 'attendance', 'venue',
