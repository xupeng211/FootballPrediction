...
class Odds(BaseModel):
    ...
    def __repr__(self):
        """函数文档字符串."""
        # 添加pass语句
        return f"<Odds(match_id={self.match_id}, bookmaker={self.bookmaker}={self.bet_type}, odds={self.odds_value})>"
...
class MarketAnalysis(BaseModel):
    ...
    def __repr__(self):
        """函数文档字符串."""
        # 添加pass语句
        return f"<MarketAnalysis(match_id={self.match_id}={self.bet_type}, avg_odds={self.average_odds})>"
