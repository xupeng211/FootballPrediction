...
(__VLS_ctx.isHealthy ? 'API Connected' : 'API Disconnected');
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex-shrink-0 bg-primary-100 rounded-full p-3" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex-shrink-0 bg-green-100 rounded-full p-3" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex-shrink-0 bg-yellow-100 rounded-full p-3" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex-shrink-0 bg-blue-100 rounded-full p-3" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
...
if (__VLS_ctx.error) {
    ...
    let __VLS_5;
    const __VLS_6 = {
        onRetry: (__VLS_ctx.refreshData)
    };
    var __VLS_2;
}
if (__VLS_ctx.loading && __VLS_ctx.predictions.length === 0) {
...
if (!__VLS_ctx.loading || __VLS_ctx.predictions.length > 0) {
    ...
    (__VLS_ctx.showHighConfidenceOnly);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "text-sm text-gray-700" },
    });
    if (__VLS_ctx.filteredPredictions.length === 0) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        for (const [prediction] of __VLS_getVForSourceType((__VLS_ctx.filteredPredictions))) {
            /** @type {[typeof PredictionCard, ]} */ ;
            // @ts-ignore
            const __VLS_10 = __VLS_asFunctionalComponent(PredictionCard, new PredictionCard({
                key: (prediction.match_id),
                prediction: (prediction),
                match: (__VLS_ctx.getMatchForPrediction(prediction)),
            }));
...
if (__VLS_ctx.matchesLoading) {
    /** @type {[typeof LoadingSpinner, ]} */ ;
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(LoadingSpinner, new LoadingSpinner({
...
else if (__VLS_ctx.upcomingMatches.length > 0) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "grid grid-cols-1 lg:grid-cols-3 gap-4" },
    });
    for (const [match] of __VLS_getVForSourceType((__VLS_ctx.upcomingMatches.slice(0, 6)))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            key: (match.id),
        ...
        (__VLS_ctx.formatDateTime(match.scheduled_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "text-center" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            getMatchForPrediction: getMatchForPrediction,
