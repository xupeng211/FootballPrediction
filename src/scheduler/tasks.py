...
def process_bronze_to_silver(self, batch_size: int = 1000):
    ...
    try:
        ...
        async def _save_to_silver_layer(session, silver_data, bronze_table):
            ...
            # 确定Silver表名
            silver_table_map = {
                "raw_match_data": "silver_matches",
                "raw_odds_data": "silver_odds",
                "raw_scores_data": "silver_scores",
            }
            ...
            if bronze_table == "raw_match_data":
                ...
                if silver_table == "processed_odds":
                    insert_query = """
                ...
                if silver_table == "processed_scores":
                    insert_query = """
