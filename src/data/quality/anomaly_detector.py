...
class AnomalyDetector:
    ...
    def detect_statistical_outliers(self, data: Union[List[float], pd.Series], threshold: float = 3.0)
    ) -> List[int:
    ...
    def detect_missing_values(self, df: pd.DataFrame, threshold: float = 0.1)
    ) -> Dict[str, float:
