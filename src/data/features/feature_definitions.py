...
class FeatureDefinitions:
    ...
    FEATURE_VIEWS = {
        ...
        "team_recent_stats": {
            ...
            "ttl_days": 7,
            "features": [
                "recent_5_wins", "recent_5_goals_for", "recent_5_goals_against",
                "recent_10_wins", "home_wins", "away_wins"
            ]
        },
        "odds_features": {
            "name": "odds_features",
...
class FeatureServices:
    ...
    MATCH_PREDICTION = {
        ...
        "features": ["match_features", "team_recent_stats", "odds_features", "head_to_head_features"],
