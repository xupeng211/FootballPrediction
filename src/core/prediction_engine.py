...
def _lazy_import() -> None:
    """延迟导入以避免循环导入"" global PredictionEngine, PredictionConfig, PredictionStatisticsif PredictionEngine is None

    from .prediction import PredictionEngine as _PEfrom .prediction.config import PredictionConfig as _PC
