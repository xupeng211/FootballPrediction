...
def extract_core_words(team_name: str) -> list[str]:
    ...
    stopwords = {"cf", "fc", "ac", "as", "ss", "sd", "rcd", "ud", "cd", "vs",
                  ...
                  "milan", "hotspur", "albion", "wanderers", "rovers",
                  "palace", "villa", "forest", "county", "town"}
    ...
    special_short_words = {
        ...
        "venezia", "palermo", "spezia", "leverkusen", "gladbach", "hoffenheim", "wolfsburg",
        "dortmund", "freiburg", "bremen", "hamburg",
        "koln", "mainz", "augsburg", "stuttgart", "heidenheim",
        "bochum", "pauli", "holstein", "darmstadt", "braunschweig",
        "köln", "mönchengladbach", "fürth", "monchengladbach", "madrid", "barcelona", "sevilla", "valencia", "betis",
        "sociedad", "bilbao", "villarreal", "valladolid", "getafe",
        "espanyol", "celta", "mallorca", "osasuna", "alaves",
        "rayo", "girona", "leganes", "almeria", "palmas",
        "elche", "levant", "granada", "cadiz", " PSG",
    }
