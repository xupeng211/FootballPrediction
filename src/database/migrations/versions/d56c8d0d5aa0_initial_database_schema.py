...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "home_odds", sa.DECIMAL(precision=8, scale=4), nullable=True, comment="主胜赔率"
        ),
        sa.Column(
            "draw_odds", sa.DECIMAL(precision=8, scale=4), nullable=True, comment="平局赔率"
        ),
        sa.Column(
            "away_odds", sa.DECIMAL(precision=8, scale=4), nullable=True, comment="客胜赔率"
        ),
        sa.Column(
            "over_odds", sa.DECIMAL(precision=8, scale=4), nullable=True, comment="大球赔率"
        ),
        sa.Column(
            "under_odds",
        ...
        sa.Column(
            "line_value", sa.DECIMAL(precision=4, scale=2), nullable=True, comment="盘口值"
        ),
    ...
    op.create_table(
        ...
        # 基础统计特征
        sa.Column(
            "recent_5_wins", sa.Integer(), nullable=False, default=0, comment="最近5场胜利场次"
        ),
        sa.Column(
            "recent_5_draws",
            sa.Integer(),
        ...
        sa.Column(
            "home_draws", sa.Integer(), nullable=False, default=0, comment="主场平局场次"
        ),
        sa.Column(
            "home_losses", sa.Integer(), nullable=False, default=0, comment="主场失败场次"
        ),
        sa.Column(
            "away_wins", sa.Integer(), nullable=False, default=0, comment="客场胜利场次"
        ),
        sa.Column(
            "away_draws", sa.Integer(), nullable=False, default=0, comment="客场平局场次"
        ),
        sa.Column(
            "away_losses", sa.Integer(), nullable=False, default=0, comment="客场失败场次"
        ),
        # 对战历史特征
        sa.Column(
            "h2h_wins", sa.Integer(), nullable=False, default=0, comment="历史交锋胜利场次"
        ),
        sa.Column(
            "h2h_draws", sa.Integer(), nullable=False, default=0, comment="历史交锋平局场次"
        ),
        sa.Column(
            "h2h_losses", sa.Integer(), nullable=False, default=0, comment="历史交锋失败场次"
        ),
        sa.Column(
            "h2h_goals_for", sa.Integer(), nullable=False, default=0, comment="历史交锋进球数"
        ),
        sa.Column(
            "h2h_goals_against",
            sa.Integer(),
        ...
        # 其他特征
        sa.Column(
            "days_since_last_match", sa.Integer(), nullable=True, comment="距离上场比赛天数"
        ),
        sa.Column(
            "is_derby", sa.Boolean(), nullable=False, default=False, comment="是否为德比战"
        ),
        sa.Column(
            "avg_possession",
        ...
        sa.Column(
            "clean_sheets", sa.Integer(), nullable=False, default=0, comment="零失球场次"
        ),
        sa.Column(
            "avg_cards_per_game",
            sa.DECIMAL(precision=4, scale=2),
        ...
        sa.Column(
            "unbeaten_streak", sa.Integer(), nullable=False, default=0, comment="不败场次"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False, comment="创建时间"),
        sa.Column("updated_at", sa.DateTime(), nullable=False, comment="更新时间"),
        sa.ForeignKeyConstraint(["match_id"], ["matches.id"]),
