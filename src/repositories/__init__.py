...
from .base import (BaseRepository, QuerySpec, ReadOnlyRepository, Repository,
                   WriteOnlyRepository)
from .di import (MatchRepoDep, PredictionRepoDep, ReadOnlyMatchRepoDep,
                 ReadOnlyPredictionRepoDep, ReadOnlyUserRepoDep, RepositoryDep,
                 UserRepoDep)
...
from .di import (get_read_only_match_repository,
                 get_read_only_prediction_repository,
                 get_read_only_user_repository)
from .di import get_user_repository as get_user_repo_dep
from .match import (MatchRepository, MatchRepositoryInterface,
                    ReadOnlyMatchRepository)
from .prediction import (PredictionRepository, PredictionRepositoryInterface,
                         ReadOnlyPredictionRepository)
from .provider import (DefaultRepositoryFactory, RepositoryFactory,
                       RepositoryProvider, get_match_repository,
                       get_prediction_repository, get_repository_provider,
                       get_user_repository, set_repository_provider)
