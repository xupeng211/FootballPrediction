...
class HarvesterSettings(BaseSettings):
    ...
    # 兼容旧环境变量
    football_db_host: Optional[str] = Field(default=None, alias='FOOTBALL_DB_HOST')
    football_db_name: Optional[str] = Field(default=None, alias='FOOTBALL_DB_NAME')
...
# ==================== 单例模式 ====================
_harvester_settings: Optional[HarvesterSettings] = None
