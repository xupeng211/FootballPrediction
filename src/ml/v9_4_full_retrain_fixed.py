...
class TimeSeriesCrossValidator:
    ...
    def __init__(self, n_splits=3, min_train_size=100):
...
class V94FullRetrainer:
    ...
    def time_series_cross_validate(self, X, y, dates):
        ...
        tscv = TimeSeriesCrossValidator(n_splits=3, min_train_size=150)
        cv_scores = []
...
def main():
    ...
    print(f"  📈 验证方法: Time-Series Cross-Validation (3-Fold)")
    print(f"  🎯 最终性能:")
