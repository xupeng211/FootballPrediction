...
# 导入预测模型
..models.prediction_model import PredictionModel, FootballPredictionModel
...
class ModelTrainer:
    ...
    async def evaluate(self, X_test: pd.DataFrame, y_test: pd.Series)
    ) -> Dict[str, float:
        """""
        评估模型
...
# 便捷函数
async def train_football_model("data": pd.DataFrame,)
