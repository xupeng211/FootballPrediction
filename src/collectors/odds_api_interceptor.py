...
from src.collectors.odds_production_extractor import TARGET_ENTITIES, MultiSourceEntityData, logger
...
class OddsAPIInterceptor:
    ...
    Typical usage:
        ...
        if result.success:
            logger.info(f"Captured: {result.data.init_h} @ {result.data.opening_time_h}")
    """
