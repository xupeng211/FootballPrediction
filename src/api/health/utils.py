...
使用示例:
    from src.api.health.utils import HealthCheckerchecker = HealthChecker()
...
,
        ...
        # 判断整体状态
        overall_status = "healthy for check in checks.values()
":
            if check.get("status") not in ["healthy", "ok"]
    overall_status = "unhealthy break
"
