...
:
    """球队查询参数"" country:
    str | None = Field(None, description="国家")
...
:
    """创建球队请求"" name: str = Field(..., min_length=1, max_length=100, description="球队名称")
    country:
    str | None = Field(None, max_length=50, description="国家")
...
:
    """更新球队请求"" name: str | None = Field(None, min_length=1, max_length=100, description="球队名称")
    country:
    str | None = Field(None, max_length=50, description="国家")
    founded_year: int | None = Field(None, ge=1800, le=2030, description="成立年份")
    stadium: str | None = Field(None, max_length=100, description="球场名称")
