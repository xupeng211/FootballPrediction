...
:
    """服务检查结果模型"" status: str = Field(..., description="服务状态")
...
:
    """健康检查API响应模型"" status: str = Field(..., description="整体健康状态")
...
:
    """服务状态API响应模型"" status: str = Field(..., description="整体状态")
...
:
    """监控指标API响应模型"" status: str = Field(..., description="API状态")
    response_time_ms: float = Field(..., description="响应时间(毫秒))
""
...
:
    """根路径API响应模型"" service: str = Field(..., description="服务名称")
...
:
    """错误响应模型"" error: bool = Field(..., description="是否为错误")
