...
"" from abc import ABCfrom datetime import datetime
...
:
    ...
    "" def __init__(self, aggregate_id: Optional[int] = None) -> None:
        "" 初始化领域事件
        ...
        self.aggregate_id = aggregate_idself.occurred_at = datetime.utcnow()

        self.version = 1

    def to_dict(self) -> Dict[str, Any]:
        """转换为字典"" return {"event_id": self.event_id,)
