...
from .subscriptions import get_subscription_manager, subscribe_to_predictions, subscribe_to_matches, subscribe_to_odds
...
class WebSocketHandler:
    ...
    async def _handle_subscribe(self, connection_id: str, data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.info(f"Connection {connection_id} subscribed to {success_count} event types")
    ...
    async def _handle_unsubscribe(self, connection_id: str, data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.info(f"Connection {connection_id} unsubscribed from {success_count} event types")
