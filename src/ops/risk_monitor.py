...
"""
    ...
    def get_status_summary(self) -> Dict:
        ...
        return {
            ...
            'yield_pct': ((self.metrics.current_balance - self.metrics.initial_balance) / self.metrics.initial_balance) * 100,
            'consecutive_losses': self.metrics.consecutive_losses,
            'max_drawdown_pct': self.metrics.max_drawdown_pct,
            'is_stopped': self.metrics.is_emergency_stopped,
            'total_bets': self.metrics.total_bets,
            'win_rate': (self.metrics.winning_bets / self.metrics.total_bets * 100) if self.metrics.total_bets > 0 else 0
        }
