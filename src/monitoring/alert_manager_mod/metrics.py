...
class PrometheusMetrics:
    ...
    def __init__(self, registry: Optional[CollectorRegistry] = None, namespace: str = "alerts"):
        初始化Prometheus指标
    ...
    def record_alert_resolved(self, level: str, alert_type: str, source: str, duration_seconds: float):
        记录告警解决
