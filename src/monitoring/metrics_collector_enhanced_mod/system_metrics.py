...
class SystemMetricsCollector:
    ...
    def __init__(
        self,
        prometheus_manager: PrometheusMetricsManager,
    ...
    def update_system_metrics(self):
        ...
        try:
            ...
            self.prometheus.set_gauge(
                "memory_usage", memory_info.rss, labels={"component": "rss"}
            )
            self.prometheus.set_gauge(
                "memory_usage", memory_info.vms, labels={"component": "vms"}
            )
            ...
            self.prometheus.set_gauge(
                "cpu_usage", cpu_percent, labels={"component": "app"}
            )
