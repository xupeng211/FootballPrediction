...
class ExternalMatch(Base):
    ...
    nullable=False,
    comment="主队名称")
    home_team_short_name = Column(String(50),
    nullable=True,
    comment="主队简称")
    home_team_crest = Column(Text,
    nullable=True,
    comment="主队队徽URL")
    ...
    nullable=False,
    comment="客队名称")
    away_team_short_name = Column(String(50),
    nullable=True,
    comment="客队简称")
    away_team_crest = Column(Text,
    nullable=True,
    comment="客队队徽URL")
    ...
    result = Column(
        String(20),
    nullable=True,
    comment="比赛结果(home_win/away_win/draw)"
    )
    ...
    def from_api_data(cls, data: dict) -> "ExternalMatch":
        ...
        try:
            ...
            if utc_date:
                try:
                    match_date = datetime.fromisoformat(utc_date.replace("Z",
    "+00:00"))
                except ValueError:
                    pass
