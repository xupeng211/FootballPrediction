...
from src.utils.team_alias import (
    normalize_team_name,
    calculate_similarity as legacy_calculate_similarity,
)
...
class BridgeRadarEngine:
    ...
    def __init__(self, config: Optional[RadarEngineConfig] = None):
        """
        初始化雷达引擎
...
_radar_engine_instance: Optional[BridgeRadarEngine] = None
