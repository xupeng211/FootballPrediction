    ...
    0:00Z",","
                        ...
                        "checks": {",")
                            ...
                            "ml_model": {",")
                                ...
                                "details": {",")
                                    "model_version": "v2.1.0",","
                                    "last_prediction": "2024-01-01T09: 4,
    5:00Z",","
...
"    y: your-api-key\n3. 正常调用 API",","
"                    "example": "curl -H 'X-API-Key: your-api-key' http,
"    s://api.football-prediction.com/predictions/match_123",""
"                ,
                "BearerAuth": {",")
                    "type": "http",","
                    "scheme": "bearer",","
                    "bearerFormat": "JWT",","
                    "description": "JWT Bearer Token 认证流程: \n1. 使用用户名密码登录获取 JWT\n2. 在请求头中添加 Authorizatio,
"    n: Bearer <jwt-token>\n3. Token 有效期为 24 小时",","
"                    "example": "curl -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...' http,
"    s://api.football-prediction.com/predictions/match_123",""
"                ,
