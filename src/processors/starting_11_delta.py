...
class PlayerInfo:
    ...
    market_value: Optional[float] = None  # 身价（百万欧元）
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("V41.450 Starting-11 Delta Calculator Demo")
    print("=" * 70)
    print("\n特征输出:")
    ...
    print("\n关键信号:")
    print(f"  主队缺阵大腿数: {features['home_missing_stars_count']}")
    print(f"  主队缺阵大腿总评分: {features['home_missing_stars_total_rating']:.2f}")
    print(f"  主队战力削弱信号: {features['home_critical_weakened']}")
    print("=" * 70)
