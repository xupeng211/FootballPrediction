...
if __name__ == "__main__":
    ...
    logger.info("\n" + "=" * 70)
    logger.info("V41.450 Pre-Match Feature Extraction Demo")
    logger.info("=" * 70)
    logger.info(f"Original features: {extractor.extracted_count}")
    logger.info(f"Rejected features: {extractor.rejected_count}")
    logger.info(f"Extraction rate: {extractor.get_extraction_rate():.1%}")
