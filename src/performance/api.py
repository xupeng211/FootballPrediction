...
async def get_performance_metrics():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get performance metric,)
"    s: {str(e)}"
"        raise HTTPException()
...
async def start_profiling(config: PerformanceRequest):
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to start profilin,)
"    g: {str(e)}"
"        raise HTTPException()
...
async def stop_profiling():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to stop profilin,)
"    g: {str(e)}"
"        raise HTTPException()
...
async def get_profiling_results():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get profiling result,)
"    s: {str(e)}"
"        raise HTTPException()
...
@router.get("/report")
async def get_performance_report(background_tasks): BackgroundTasks,
...
:
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to generate performance repor,)
"    t: {str(e)}"
"        raise HTTPException()
...
@router.get("/insights")
async def get_performance_insights(severity): str | None = Query(None, regex="^(critical|high|medium|low)$"),
...
:
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get performance insight,)
"    s: {str(e)}"
"        raise HTTPException()
...
async def get_performance_score():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get performance scor,)
"    e: {str(e)}"
"        raise HTTPException()
...
@router.get("/trends")
async def get_performance_trends(metric): str = Query(..., description="指标名称"),
...
:
    ...
    e: 从数据库或时序数据库获取历史数据
        ...
        if abs(slope) < 0.1: trend = "stable"  # typ,
    e: ignore
        elif slope > 0: trend = "increasing"  # type: ignore,
    else:
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get performance trend,)
"    s: {str(e)}"
"        raise HTTPException()
...
async def update_threshold(threshold: ThresholdUpdate):
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to update threshol,)
"    d: {str(e)}"
...
async def get_thresholds():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get threshold,)
"    s: {str(e)}"
...
async def reset_performance_stats():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to reset performance stat,)
"    s: {str(e)}"
"        raise HTTPException()
...
async def get_performance_dashboard():
    ...
    except (ValueError, KeyError, AttributeError, HTTPError, RequestException) as e: logger.error(f"Failed to get dashboard dat,)
"    a: {str(e)}"
