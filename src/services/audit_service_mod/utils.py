...
def calculate_operation_risk(
    ...
    sensitive_tables = {
        ...
        "user_profiles", "payment_info", "personal_data", "audit_logs"
    }
...
def extract_resource_info(
    ...
    # 常见的资源ID参数名
    resource_id_params = [
        "resource_id", "id", "match_id", "user_id", "fixture_id",
        "prediction_id", "team_id", "league_id", "season_id"
    ]
