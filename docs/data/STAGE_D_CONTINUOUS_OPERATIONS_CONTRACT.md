...
STAGE_D_ENTRYPOINT=scripts/ops/stage_d_cycle.js --dry-run (public offline); scripts/ops/stage_d_quota_adjudication.js (offline-only owner adjudication); scripts/ops/stage_d_candidate_prepare.js (offline-only candidate); scripts/ops/stage_d_controlled_initialization.js (future separately authorized live binder)
