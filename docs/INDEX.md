...
## Reference
- [API 500 错误分析报告](reference/API_500_ERROR_ANALYSIS.md)
- [API Documentation Style Guide](reference/API_DOCUMENTATION_STYLE_GUIDE.md)
- [📚 FootballPrediction API 参考文档](reference/API_REFERENCE.md)
- [Comprehensive API Documentation Style Guide](reference/COMPREHENSIVE_API_DOCUMENTATION_STYLE_GUIDE.md)
...
## Release
*(No documents currently in Release category)*

## Staging
*(No documents currently in Staging category)*

## Legacy
- [CI 最终修复报告](legacy/CI_FINAL_REPORT.md)
- [CI Fast vs Slow 测试对比报告](legacy/CI_REPORT.md)
...
- [⚠️ 说明：所有 Blocker 项目必须完成，才允许进入生产上线。](legacy/RELEASE_CHECKLIST.md)
- [足球预测系统安全文档](legacy/SECURITY.md)
- [🎯 足球预测系统 Staging 环境部署彩排演练流程](legacy/STAGING_DEPLOYMENT_REHEARSAL.md)
- [Deprecated](legacy/ci_defense_mechanisms.md)
- [Deprecated](legacy/rules.md)
- [🛡️ FootballPrediction 项目安全检查清单](legacy/security-checklist.md)
