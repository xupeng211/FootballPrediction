...
class TestVenueAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data = {
            ...
            'match_date': [
                '2024-01-01', '2024-01-15', '2024-02-01',
                '2024-01-05', '2024-01-20', '2024-02-05',
...
class TestAdvancedFeatureTransformer(unittest.TestCase):
    ...
    def test_feature_correlation_analysis(self):
        ...
        df_with_target['target'] = (df_with_target['home_score'] >
                                   df_with_target['away_score']).astype(int)

        # 转换特征
        df_with_features = self.transformer.transform(df_with_target)

        # 分析相关性
        correlations = self.transformer.analyze_feature_correlation(
            df_with_features
        )
