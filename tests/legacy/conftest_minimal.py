...
@pytest.fixture(scope = os.getenv("CONFTEST_MINIMAL_SCOPE_15"))
def event_loop():
...
def mock_mlflow_client():
    ...
    mock_version_info.current_stage = os.getenv("CONFTEST_MINIMAL_CURRENT_STAGE_66")
    mock_version_info.name = os.getenv("CONFTEST_MINIMAL_NAME_67")
