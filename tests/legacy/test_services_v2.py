...
- InferenceServiceV2: 推理服务的业务逻辑、批量预测、统计信息
...
class TestInferenceServiceV2(unittest.TestCase):
    """测试 InferenceServiceV2 推理服务"""
...
if __name__ == '__main__':
    ...
    suite.addTest(unittest.makeSuite(TestInferenceServiceV2))
