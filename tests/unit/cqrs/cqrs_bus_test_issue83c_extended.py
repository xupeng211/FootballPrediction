...
class TestCqrsbus:
    ...
    def setup_mocks(self):
        """自动设置增强Mock"""
        with EnhancedMockContextManager(["cqrs"]) as mocks:
            self.mocks = mocks
            yield
    ...
    def test_module_import_with_enhanced_mocks(self):
        ...
        try:
            ...
            module = importlib.import_module("cqrs.bus")

            assert module is not None, "模块应该能导入"
            print("✅ 成功导入模块: cqrs.bus")
