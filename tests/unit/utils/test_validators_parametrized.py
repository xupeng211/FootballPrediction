...
class TestValidatorsComplex:
    ...
    @pytest.mark.parametrize("data,field_rules,expected", [
        # 批量验证
        (
    ...
    @pytest.mark.parametrize("input_data,sanitizer,expected", [
        # 清理和验证
    ...
    @pytest.mark.parametrize("business_rules,data,expected", [
        # 业务规则验证
