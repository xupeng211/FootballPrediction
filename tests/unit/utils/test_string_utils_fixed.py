...
class TestStringUtilsCamelToSnake:
    ...
    def test_camel_to_snake_multiple_words(self):
        """测试：多个单词的驼峰"""
        result = StringUtils.camel_to_snake("helloWorldTest")
        assert result == "hello_world_test"

    def test_camel_to_snake_all_caps(self):
        """测试：全大写"""
        result = StringUtils.camel_to_snake("API")
        # 实际实现可能返回原样
    ...
    def test_camel_to_snake_already_snake(self):
        """测试：已经是下划线格式"""
        result = StringUtils.camel_to_snake("hello_world")
        assert result == "hello_world"

    def test_camel_to_snake_with_numbers(self):
        """测试：带数字"""
        result = StringUtils.camel_to_snake("test123ABC")
        assert result in ["test123_a_b_c", "test123abc"]

    def test_camel_to_snake_single_letter(self):
        """测试：单个字母"""
        result = StringUtils.camel_to_snake("A")
        assert result == "a"
...
class TestStringUtilsSnakeToCamel:
    ...
    def test_snake_to_camel_leading_underscore(self):
        """测试：前导下划线"""
        result = StringUtils.snake_to_camel("_hello_world")
        assert result == "_helloWorld"

    def test_snake_to_camel_trailing_underscore(self):
        """测试：后置下划线"""
        result = StringUtils.snake_to_camel("hello_world_")
        # 实际实现可能保留后置下划线
        assert result == "helloWorld_"

    def test_snake_to_camel_multiple_underscores(self):
        """测试：多个下划线"""
        result = StringUtils.snake_to_camel("hello_world_test_case")
        assert result == "helloWorldTestCase"

    def test_snake_to_camel_single_word(self):
        """测试：单个单词"""
        result = StringUtils.snake_to_camel("hello")
        assert result == "hello"
    ...
    def test_snake_to_camel_with_numbers(self):
        """测试：带数字"""
        result = StringUtils.snake_to_camel("test_123_case")
...
class TestStringUtilsExtractNumbers:
    ...
    def test_extract_numbers_multiple(self):
        ...
        result = StringUtils.extract_numbers(text)
        assert result == [1.0, 2.5, -3.0, 4.56]
