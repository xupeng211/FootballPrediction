...
class TestDomainModels:
    ...
    def test_league_methods(self):
        ...
        common_methods = ["to_dict", "from_dict", "update", "clone"]
    ...
    def test_match_result_enum(self):
        """测试比赛结果枚举"""
        try:
            results = [MatchResult.HOME_WIN, MatchResult.AWAY_WIN, MatchResult.DRAW]
    ...
    def test_match_validation(self):
        """测试比赛验证"""
        match = Match(id=1, home_team_id=1, away_team_id=2, league_id=1)
    ...
    def test_team_creation(self):
        """测试队伍创建"""
        team = Team(id=1, name="Manchester United", country="England")
    ...
    def test_team_attributes(self):
        """测试队伍属性"""
        team = Team(id=1, name="Test Team", country="Test Country")
    ...
    def test_team_methods(self):
        ...
        common_methods = ["to_dict", "from_dict", "update", "clone", "get_display_name"]
    ...
    def test_model_error_handling(self):
        ...
        try:
            # 测试无效数据
            invalid_data = [None, "invalid_string", 123, [], {}]
