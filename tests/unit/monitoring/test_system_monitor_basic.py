...
def test_convenience_functions():
    ...
    with patch('src.monitoring.system_monitor_mod.utils.get_system_monitor', return_value=monitor):
        # 测试便捷函数
        ...
        monitor.record_database_query.assert_called_once_with('SELECT', 'matches', 0.045)
