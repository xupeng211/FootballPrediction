...
class TestAlertManagerBatchOmega002:
    ...
    def test_alert_with_labels_and_annotations(self):
        ...
        annotations = {"description": "Test alert", "severity": "high"}
    ...
    def test_update_anomaly_metrics(self, alert_manager):
        ...
        # 创建模拟的异常对象
        mock_anomaly = Mock()
        mock_anomaly.table_name = "matches"
        mock_anomaly.column_name = "home_score"
        mock_anomaly.anomaly_type = Mock()
        mock_anomaly.anomaly_type.value = "statistical"
        mock_anomaly.severity = Mock()
        mock_anomaly.severity.value = "high"
        mock_anomaly.anomaly_score = 0.15
    ...
    def test_check_and_fire_anomaly_alerts(self, alert_manager):
        ...
        mock_anomaly.severity = Mock()
        mock_anomaly.severity.value = "high"
        mock_anomaly.description = "异常高的得分"
        mock_anomaly.anomaly_score = 0.25  # 超过0.2
    ...
    def test_send_alert_error_handling(self, alert_manager):
        ...
        alert_manager.register_handler(AlertChannel.LOG, error_handler)
