...
class TestConfigurationBasics:
    ...
    def test_database_settings_creation(self):
        ...
        class MockDatabaseSettings:
            def __init__(self, host="localhost", port=5432, user="test_user",
                        password="test_pass", database="test_db", url=None):
                self.host = host
                self.port = port
                self.user = user
    ...
    def test_fotmob_settings_creation(self):
        ...
        class MockFotMobSettings:
            def __init__(self, base_url="https://api.fotmob.com", x_mas_header="", x_foo_header=""):
        ...
        custom_settings = MockFotMobSettings(
            x_mas_header="custom-mas-token",
            x_foo_header="custom-foo-token"
        )
    ...
    def test_application_settings_creation(self):
        ...
        class MockApplicationSettings:
            def __init__(self, name="Football Prediction API", version="1.0.0",
                        host="0.0.0.0", port=8000, debug=False, secret_key="test-key"):
                self.name = name
