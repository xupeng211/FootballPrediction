"""
Issue #83-C 扩展测试: core.exceptions
覆盖率目标: 60% → 80%
...
class TestCoreexceptions:
    ...
    def setup_mocks(self):
        """自动设置增强Mock"""
        with EnhancedMockContextManager([]) as mocks:
            self.mocks = mocks
            yield
    ...
    def test_module_import_with_enhanced_mocks(self):
        ...
        try:
            ...
            module = importlib.import_module("core.exceptions")

            assert module is not None, "模块应该能导入"
            print("✅ 成功导入模块: core.exceptions")
