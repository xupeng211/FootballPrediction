...
def create_mock_inference_service() -> AsyncMock:
    ...
    inference_service.health_check = AsyncMock(return_value={
        'healthy': True,
        'initialized': True,
...
def create_mock_collection_service() -> AsyncMock:
    ...
    collection_service.collect_match_data = AsyncMock(return_value={
        'success': True,
        'data_points': 125,
...
def create_mock_fotmob_client() -> AsyncMock:
    ...
    fotmob_client.get_match_data = AsyncMock(return_value={
        'match_id': 'test_match_001',
        'home_team': 'Man Utd',
        'away_team': 'Arsenal',
        'score': {'home': 2, 'away': 1},
    ...
    fotmob_client.get_team_stats = AsyncMock(return_value={
        'team': 'Man Utd',
        'form': ['W', 'D', 'W', 'L', 'W'],
        'goals_scored': 15,
        'goals_conceded': 8
...
def create_mock_notification_service() -> AsyncMock:
    ...
    notification_service.send_alert = AsyncMock(return_value={
        'sent': True,
        'channel': 'email',
        'message_id': 'alert_001'
    })

    notification_service.send_report = AsyncMock(return_value={
        'sent': True,
        'channel': 'slack',
        'recipients': 5
    })
