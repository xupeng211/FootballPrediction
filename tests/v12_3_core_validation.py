...
class V123CoreValidation:
    ...
    def test_historical_filter_logic(self):
        ...
        # 构造测试日期
        future_date = datetime(2025, 12, 30, 15, 0, 0, tzinfo=UTC)
        historical_date = datetime(2024, 5, 10, 15, 0, 0, tzinfo=UTC)
    ...
    def test_data_structure_validation(self):
        ...
        valid_structure = {
            "header": {
                ...
                "status": {"utcTime": "2024-12-22T15:00:00Z", "finished": True, "scoreStr": "2-1"},
            },
