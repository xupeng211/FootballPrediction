...
function runtimeReceipt({
    ...
    databaseIdentity,
    serviceIdentity,
    databaseInstanceOid = 'synthetic-database-instance-oid',
    databaseInstanceNonce = '00000000-0000-4000-8000-000000000001',
    ...
    return signRuntimeAuthorization({
        ...
        target: {
            ...
            database_instance_oid: databaseInstanceOid,
            database_instance_nonce: databaseInstanceNonce,
