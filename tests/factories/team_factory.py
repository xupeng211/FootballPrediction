...
class TeamFactory(BaseFactory, DataFactoryMixin, TimestampMixin):
    ...
    # 示例球队名称池
    TEAM_NAMES = [
        "皇家马德里", "巴塞罗那", "曼彻斯特联", "利物浦", "拜仁慕尼黑",
        "巴黎圣日耳曼", "尤文图斯", "AC米兰", "国际米兰", "切尔西",
        "曼城", "阿森纳", "热刺", "多特蒙德", "马德里竞技",
        "那不勒斯", "罗马", "拉齐奥", "本菲卡", "波尔图"
    ]

    # 示例城市
    CITIES = [
        "马德里", "巴塞罗那", "曼彻斯特", "利物浦", "慕尼黑",
        "巴黎", "都灵", "米兰", "罗马", "伦敦",
        "多特蒙德", "里斯本", "波尔图", "那不勒斯", "本菲卡"
    ]
...
class ChineseTeamFactory(TeamFactory):
    ...
    CHINESE_TEAM_NAMES = [
        "北京国安", "上海海港", "广州恒大", "山东泰山", "大连人",
        "天津津门虎", "河南嵩山龙门", "长春亚泰", "河北队", "沧州雄狮",
        "武汉三镇", "梅州客家", "成都蓉城", "青岛海牛", "南通支云"
    ]
...
class HistoricTeamFactory(TeamFactory):
    ...
    HISTORIC_TEAM_NAMES = [
        "AC米兰 (1980s)", "皇家马德里 (1950s)", "巴塞罗那 (1990s)",
        "曼联 (1960s)", "利物浦 (1970s)", "拜仁慕尼黑 (1970s)",
        "阿贾克斯 (1970s)", "国际米兰 (1960s)", "尤文图斯 (1980s)",
        "凯尔特人 (1960s)", "本菲卡 (1960s)", "波尔图 (1980s)"
    ]
