...
class TeamFactory(SQLAlchemyModelFactory):
    ...
    external_team_id = factory.LazyAttribute(lambda _: f"team_{fake.uuid4().hex[:8]}")
    ...
    stadium_name = factory.LazyAttribute(lambda _: f"{fake.company()} Stadium")
    stadium_capacity = factory.LazyAttribute(lambda _: random.randint(20000, 90000))
