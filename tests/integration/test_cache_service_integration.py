...
def test_cache_pattern_configuration(cache_pattern, data_type, expected_ttl):
    """测试缓存模式配置"""
    # 验证配置格式
...
def test_cache_operation_rules(operation, cache_key, should_cache):
    """测试缓存操作规则"""
    # 验证规则
