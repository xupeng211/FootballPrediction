...
def test_event_routing_configuration(event_type, topic, partition_key, client, client):
    """测试事件路由配置"""
    # 验证路由配置
...
def test_message_size_handling(client, message_size, expected_behavior, client, client):
    """测试消息大小处理"""
    # 验证消息大小限制
