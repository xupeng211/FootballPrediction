...
def test_domain_models(client, client, client, client, client, client, client, client, client, client, client, client, client):
    """测试领域模型基本功能"""
    print("🧪 测试领域模型...")
...
def test_prediction_logic(client, client, client, client, client, client, client, client, client, client, client, client, client):
    """测试预测逻辑"""
    print("🧪 测试预测逻辑...")
...
def test_api_models(client, client, client, client, client, client, client, client, client, client, client, client, client):
    """测试API数据模型"""
    print("🧪 测试API数据模型...")
...
def test_utils_functionality(client, client, client, client, client, client, client, client, client, client, client, client, client):
    """测试工具函数"""
    print("🧪 测试工具函数...")
