...
async def test_football_data_api():
    """测试Football-Data.org API连接"""
    print("🔧 测试Football-Data.org API连接...")  # TODO: Add logger import if needed

    # 检查API密钥
    api_key = os.getenv("FOOTBALL_DATA_API_KEY")
    if not api_key:
        print(
            "❌ 未找到FOOTBALL_DATA_API_KEY环境变量"
        )  # TODO: Add logger import if needed
        return False

    print(
        f"✅ API密钥已配置: {api_key[:10]}...{api_key[-4:]}"
    )  # TODO: Add logger import if needed

    # 获取Football-Data.org适配器
    adapter = data_source_manager.get_adapter("football_data_org")
    if not adapter:
        print("❌ Football-Data.org适配器不可用")  # TODO: Add logger import if needed
        return False

    print("✅ Football-Data.org适配器已创建")  # TODO: Add logger import if needed

    try:
        # 测试获取比赛数据
        print("📊 测试获取比赛数据...")  # TODO: Add logger import if needed
        ...
        if matches:
            ...
            for i, match in enumerate(matches[:3], 1):
                ...
                print(f"     联赛: {match.league}")  # TODO: Add logger import if needed
                print(
...
async def main():
    ...
    if success:
        print(
            "🎉 API连接测试成功！系统已准备好使用真实数据源！"
        )  # TODO: Add logger import if needed
        print("\n📝 下一步:")  # TODO: Add logger import if needed
        print("✅ 可以通过API端点收集真实比赛数据")  # TODO: Add logger import if needed
        print("✅ 数据集成系统完全可用")  # TODO: Add logger import if needed
        print("✅ 前端可以显示真实比赛信息")  # TODO: Add logger import if needed
    else:
        print("❌ API连接测试失败，请检查配置")  # TODO: Add logger import if needed
        print("\n🔧 故障排除:")  # TODO: Add logger import if needed
        print("1. 检查API密钥是否正确")  # TODO: Add logger import if needed
        print("2. 检查网络连接")  # TODO: Add logger import if needed
        print("3. 确认Football-Data.org服务状态")  # TODO: Add logger import if needed
