...
class TestXGDataAggregator:
    ...
    def sample_shotmap_data(self):
        ...
        return {
            "shotmap": {
                "shots": [
                    {"expectedGoals": 0.15, "teamType": "home", "isHome": True},
                    {"expectedGoals": 0.25, "teamType": "away", "isHome": False},
                    {"expectedGoals": 0.05, "teamType": "home", "isHome": True},
                ]
            }
        }
    ...
    def sample_events_data(self):
        """示例events数据"""
        return {"events": {"shots": [{"expectedGoals": 0.1, "isHome": True}, {"xg": 0.2, "isHome": False}]}}
    ...
    def test_extract_xg_from_shot_nested_stats(self):
        """测试从嵌套stats中提取xG"""
        shot_data = {"stats": {"expectedGoals": 0.18, "xgTotal": 0.2}}
        xg = XGDataAggregator._extract_xg_from_shot(shot_data)
        assert xg == 0.18
...
class TestAdvancedFeatureExtractor:
    ...
    def sample_match_data(self):
        ...
        return {
            ...
            "league": {"id": "league_47", "name": "Premier League"},
            "shotmap": {
                "shots": [
    ...
    @pytest.mark.parametrize(
        "home_xg,away_xg,expected_trend",
        [(1.0, 1.0, "stable"), (2.0, 0.5, "dominant"), (0.3, 1.8, "dominant"), (0.8, 0.6, "stable")],
    )
    ...
    def test_extract_possession_features(self, feature_extractor):
        """测试提取控球率特征"""
        data_with_possession = {"stats": {"home": {"possession": 60}, "away": {"possession": 40}}}
    ...
    def test_possession_auto_calculation(self, feature_extractor):
        """测试控球率自动计算"""
        data_with_home_only = {"stats": {"home": {"possession": 65}}}
...
class Test106FieldParameterizedValidation:
    ...
    @pytest.mark.parametrize(
        "field_name,test_values,expected_valid",
        [
            # 基础字段测试
...
class TestMockFotMobResponses:
    ...
    @pytest.fixture(
        params=[
            # 结构1: 标准FotMob API响应
            {
                ...
                "shotmap": {
                    "shots": [{"expectedGoals": 0.25, "teamType": "home"}, {"expectedGoals": 0.15, "teamType": "away"}]
                },
            },
            # 结构2: 嵌套events响应
            {
                ...
                "events": {"shots": [{"xg": 0.3, "isHome": True}, {"xg": 0.2, "isHome": False}]},
            },
            # 结构3: 简化统计响应
            {
                "id": "struct3_789",
            ...
            # 结构4: 最小化响应
            {"match_id": "struct4_000", "home": "Team H", "away": "Team A", "score": {"home": 0, "away": 0}},
            # 结构5: 完整详细响应
            {
                "general": {
                    "id": "struct5_complete",
                ...
                "teams": {"home": {"name": "Complete Home"}, "away": {"name": "Complete Away"}},
                "league": {"id": "league_123", "name": "Test League"},
                "shotmap": {
                    "shots": [
                        {"expectedGoals": 0.18, "teamType": "home", "isHome": True, "stats": {"xg": 0.18}},
                        {"expectedGoals": 0.12, "teamType": "away", "isHome": False, "stats": {"xg": 0.12}},
                    ]
                },
                "stats": {
    ...
    def test_graceful_degradation_for_missing_data(self, feature_extractor):
        """测试对缺失数据的优雅降级"""
        minimal_data = {"id": "minimal_123", "home": "Home Team", "away": "Away Team"}
...
class TestIntegration:
    ...
    def test_end_to_end_extraction(self):
        ...
        real_data = {
            ...
            "homeTeam": {"id": 10260, "name": "Manchester United", "shortName": "Man Utd"},
            "awayTeam": {"id": 8650, "name": "Liverpool", "shortName": "Liverpool"},
            "league": {"id": 127, "name": "Premier League"},
            "content": {
                "shotmap": {
                    "shots": [
                        {
