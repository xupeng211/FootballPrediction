...
class TestStrategyEngine:
    ...
    def test_zero_edge_no_bet(self, strategy_engine: StrategyEngine,
    ...
    def test_negative_edge_no_bet(self, strategy_engine: StrategyEngine,
                                 sample_market_odds: Dict[str, float]):
        """
        测试负优势场景 - 严格不下注
        """
    ...
    def test_extreme_edge_respect_hard_limit(self, strategy_engine: StrategyEngine,
                                           conservative_params: BettingParameters):
        """
        测试用例2: 极端优势测试
