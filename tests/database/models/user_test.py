...
class TestUserRepository:
    ...
    @pytest.mark.asyncio
    async def test_userrole_create(self, mock_db_session, mock_repository):
        """测试UserRole仓储的创建功能"""
        # 模拟仓储创建逻辑
    ...
    @pytest.mark.asyncio
    async def test_userrole_find_by_id(self, mock_db_session, mock_repository):
        """测试UserRole仓储的查找功能"""
        # 模拟仓储实例
        mock_instance = UserRole() if hasattr(UserRole, '__call__') else Mock()
    ...
    @pytest.mark.asyncio
    async def test_userrole_update(self, mock_db_session, mock_repository):
        """测试UserRole仓储的更新功能"""
        # 模拟仓储实例
        mock_instance = UserRole() if hasattr(UserRole, '__call__') else Mock()
    ...
    @pytest.mark.asyncio
    async def test_userrole_delete(self, mock_db_session, mock_repository):
        """测试UserRole仓储的删除功能"""
        # 模拟仓储实例
        mock_instance = UserRole() if hasattr(UserRole, '__call__') else Mock()
    ...
    def test_userrole_error_handling(self, mock_repository):
        """测试UserRole仓储的错误处理"""
        # 模拟仓储实例
        mock_instance = UserRole() if hasattr(UserRole, '__call__') else Mock()
    ...
    @pytest.mark.asyncio
    async def test_user_create(self, mock_db_session, mock_repository):
        """测试User仓储的创建功能"""
        # 模拟仓储创建逻辑
    ...
    @pytest.mark.asyncio
    async def test_user_find_by_id(self, mock_db_session, mock_repository):
        """测试User仓储的查找功能"""
        # 模拟仓储实例
        mock_instance = User() if hasattr(User, '__call__') else Mock()
    ...
    @pytest.mark.asyncio
    async def test_user_update(self, mock_db_session, mock_repository):
        """测试User仓储的更新功能"""
        # 模拟仓储实例
        mock_instance = User() if hasattr(User, '__call__') else Mock()
    ...
    @pytest.mark.asyncio
    async def test_user_delete(self, mock_db_session, mock_repository):
        """测试User仓储的删除功能"""
        # 模拟仓储实例
        mock_instance = User() if hasattr(User, '__call__') else Mock()
    ...
    def test_user_error_handling(self, mock_repository):
        """测试User仓储的错误处理"""
        # 模拟仓储实例
        mock_instance = User() if hasattr(User, '__call__') else Mock()
