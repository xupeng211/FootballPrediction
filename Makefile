...
data-help: ## Show safe data harvesting entrypoint policy
	...
	@echo "  Phase 5.20L2C remaining write requires final DB-write confirmation, uses FotMobRawDetailFetcher, compares stable_raw_payload_v1 hashes, writes only raw_match_data rows=7, and does not run parser/features/training/prediction."
