...
lint: venv ## 代码风格检查
	...
	$(ACTIVATE) && python -m flake8 src/core/ src/utils/ src/database/ src/api/ tests/ --max-line-length=120 --ignore=E402,F541,F401,W503,F841,E501,E721,E712,F821,F601,E265,E722
